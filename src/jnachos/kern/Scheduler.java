...
public class Scheduler {
	...
	/**
	 * getting all the processes in the readyList
	 */
	public static LinkedList<NachosProcess> getreadyList(){
		LinkedList<NachosProcess> temp = new LinkedList<NachosProcess>();
		for(NachosProcess eachProcess : readyList){
			temp.add(eachProcess);
		}
		return temp;
	}
	/**
